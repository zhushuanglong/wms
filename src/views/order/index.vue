<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="订单ID" prop="orderId" width="150px" align="center"></el-table-column>
      ...
      <el-table-column label="时间" width="220px" align="center">
        <template slot-scope="{row}">
          <p>创建时间：{{ row.creationTime | parseTime('{y}-{m}-{d} {h}:{i}') }}</p>
          <p>更新时间：{{ row.updateTime | parseTime('{y}-{m}-{d} {h}:{i}') }}</p>
        </template>
      </el-table-column>
      ...
      <el-table-column label="物流状态" width="80px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="操作" align="center" min-width="200" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          <el-button type="primary" size="mini" @click="handleView(row.orderId)">查看</el-button>
          <el-button type="primary" size="mini">出库</el-button>
          <el-button type="primary" size="mini">入库</el-button>
          <el-button type="primary" size="mini">校正</el-button>
        </template>
      </el-table-column>
    </el-table>
